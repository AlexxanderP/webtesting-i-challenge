...
describe("enhancer.js", () => {
  describe("enhancer", () => {
    it("should return a repaired object", () => {
      ...
      expect(enhancer.repair(exampleDurabilityReducedItem)).toEqual({
        ...exampleDurabilityReducedItem,
        durability: 100
      });
    });
    ...
    it("should enhance the object according to the set rules...", () => {
      ...
      expect(enhancer.succeed(exampleEnhReducedItem)).toEqual({
        ...exampleEnhReducedItem,
        enhancement: 15
      });
    });
    it("should fail to enhance the object according to the set rules...", () => {
      //greater than 16
      expect(enhancer.fail(exampleFullItem)).toEqual({
        ...exampleFullItem,
        durability: 90,
        enhancement: 19
      });
